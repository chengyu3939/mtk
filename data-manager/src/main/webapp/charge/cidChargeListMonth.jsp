...
StringBuffer conditionStrSB=new StringBuffer("select DATE(date_time),sum(case when operator=1 then 1 else 0 end),sum(case when operator=1 then fee else 0 end),sum(case when operator=2 then 1 else 0 end),sum(case when operator=2 then fee else 0 end),sum(case when operator=3 then 1 else 0 end),sum(case when operator=3 then fee else 0 end)  from "+tableName+" where ok=1 and fee_type='A' and cid='"+sessionCid+"'");
...
<%
    ...
    for(int i=0;i<list.size();i++){
        ...
        int count3=Integer.valueOf(tempList.get(5).toString());
        int sum3=Integer.valueOf(tempList.get(6).toString());
...
<tr>
    ...
    <td><b><%=count1+count2+count3%></b></td>
    <td><b><%=(sum1+sum2+sum3)%></b></td>
</tr>
<%
}
%>
<tr>
    ...
    <td><b><%=allCount1+allCount2+allCount3%></b></td>
    <td><b><%=allSum1+allSum2+allSum3%></b></td>
</tr>
</table>
</form>
</body>
