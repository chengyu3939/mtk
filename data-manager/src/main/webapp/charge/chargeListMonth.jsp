...
"select DATE(date_time),sum(case when operator=1 then 1 else 0 end),sum(case when operator=1 then fee else 0 end),"
+" sum(case when operator=2 then 1 else 0 end),sum(case when operator=2 then fee else 0 end),"
+" sum(case when operator=3 then 1 else 0 end),sum(case when operator=3 then fee else 0 end) from "+tableName+" where ok=1");
