...
String pageSql="select province,sum(case when operator=1 then 1 else 0 end),sum(case when operator=1 then fee else 0 end),sum(case when operator=2 then 1 else 0 end),sum(case when operator=2 then fee else 0 end) from "+tableName+" where fee_type='A' and ok=1 and cid='"+sessionCid+"'";
...
<td><b><%=count2%>条</b></td>
<td><b><%=sum2%>元</b></td>
<td><b><%=count1+count2%>条</b></td>
<td><b><%=sum1+sum2%>元</b></td>
</tr>
<%
}
%>
...
<td><b><%=allSum1%>元</b></td>
<td><b><%=allCount2%>条</b></td>
<td><b><%=allSum2%>元</b></td>
<td><b><%=allCount1+allCount2%>条</b></td>
<td><b><%=allSum1+allSum2%>元</b></td>
</tr>
</table>
</form>
</body>
