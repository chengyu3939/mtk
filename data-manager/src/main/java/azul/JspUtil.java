...
public class JspUtil {
	...
	public static String initSelect(String selectName,Map map,Object obj){
		...
		try {
			...
			//对父下拉框进行排序,然后组装输出语句
			Entry[] entries= MapUtil.sortByKey(map);
	...
	public static String initSelectGroup(String selectParent,String selectSon,Map<String, String> mapParent,List listSon,Object objParent,Object objSon){
		...
		try {
			...
			//对父下拉框进行排序,然后组装输出语句
			Entry[] entries= MapUtil.sortByKey(mapParent);
			for (int i=0;i<entries.length;i++){
			       Object keyId=entries[i].getKey();
	...
	public static String[] getDateWeek(String startDate,String endDate){
		...
		if("".equals(startDate)){
			//得到的开始时间是上月数据就使用本月开头
			Date begWeek= DateUtil.getFirstDayWeek(new Date());
			Date begMonth= DateUtil.getFirstDayMonth(new Date());
			//System.out.println(date);System.out.println(DateUtil.getFirstDayMonth(new Date()));
			//本周起始日期比本月起始日期小，就是用本月起始日期
			if(begMonth.after(begWeek)){
				arr[0]= DateUtil.getDate(begMonth, DateUtil.DATE_A);
			}
			else{
				arr[0]= DateUtil.getDate(begWeek, DateUtil.DATE_A);
			}
			//本周结束日期比本月结束日期大,就是用本月结束日期
			Date endWeek= DateUtil.getLastDayWeek(new Date());
			Date endMonth= DateUtil.getLastDayMonth(new Date());
			if(endWeek.after(new Date())){
				arr[1]= DateUtil.getDate(new Date(), DateUtil.DATE_A);
			}
			else if(endWeek.after(endMonth)){
				arr[1]= DateUtil.getDate(endMonth, DateUtil.DATE_A);
			}
			else{
				arr[1]= DateUtil.getDate(endWeek, DateUtil.DATE_A);
			}
		}
		return arr;
	}
	...
	public static String[] getDateMonth(String startDate,String endDate){
		String[] arr=new String[]{startDate,endDate};
		if("".equals(startDate)){
			arr[0]= DateUtil.getDate(DateUtil.getFirstDayMonth(new Date()), DateUtil.DATE_A);
			arr[1]= DateUtil.getDate(new Date(), DateUtil.DATE_A);
		}
		return arr;
	}
	...
	public static void appendWhere(StringBuffer paramSB,StringBuffer conditionStrSB,String key,Object obj,String def,String condition,String param){
	...
	public static void appendWhere(StringBuffer paramSB,StringBuffer conditionStrSB,String[] key,String[] value){
	...
	public static String getTableName(String tableName,String startDate){
		...
		if(!"".equals(startDate)){
			tempDate= DateUtil.strToDate(startDate);
		}
	...
	public static void p(Object obj) {
		try {
			if (obj == null) {
				...
				System.out.println(DateUtil.getDate((Date)obj, DateUtil.DATE_B));
			}
	...
	public static void main(String[] args) {
		...
		System.out.println(JspUtil.getTitle(cidTypeArr,"1,2"));
